...
public abstract class Cuenta {
    ...
    private Cliente titular; // Cuando creemos una cuenta, tendrá un titular, a un cliente
    ...
    public void retirar(float cantidad) {
        ...
        if (!(saldo-cantidad>-500 && this instanceof Fondo_inversion)) { //Hacer esto sin chatGPT me ha sido una locura, pero al fin me da lo que quiero
            if (cantidad < saldo) { 
                return; // para que NO siga ejecutando el metodo
            } // fin if
