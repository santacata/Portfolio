...
public class ejercicio2 {
    ...
    public static int[][] crearmatrizaleatoria(Scanner sc){
        ...
        int longitudfilas=sc.nextInt();
        int longitudcolumnas=sc.nextInt();
    ...
    public static int[][] sumadosmatrices(int matriz[][],int matriz2[][]){
        ...
        if (matriz[0].length!=matriz2[0].length) {
            System.out.println("Las matrices tienen que ser iguales para sumarlas, intenta la proxima vez");
            return null;
            }
